...
import com.zyc.crm.service.ConsistService;
import com.zyc.crm.util.CRMUtils;

@Controller
public class ConsistHandler {

	@Autowired
	private ConsistService consistService;
	
	@RequestMapping("/report/consist")
	public String toPayUI(Map<String, Object> map,
		...
		Page<Object[]> page = consistService.getPage(pageNo, params);
		map.put("page", page);
