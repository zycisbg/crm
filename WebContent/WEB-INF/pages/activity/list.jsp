				...
				<c:forEach var="activity" items="${page.content }">
					<tr>
						...
						<td class="list_data_op">
							<img onclick="window.location.href='${ctp}/activity/toUpdateUI/${activity.id }?pageNo=${page.pageNo }'" 
								title="编辑" src="${ctp }/static/images/bt_edit.gif" class="op_button" />
							<img onclick="window.location.href='${ctp}/activity/delete/${activity.id }/${customer.id }?pageNo=${page.pageNo }'" 
