		...
		<c:forEach var="product" items="${page.content }">
			<tr>
				...
				<td class="list_data_op">
					<img onclick="window.location.href='${ctp}/product/create/${product.id }?pageNo=${page.pageNo }'" 
						title="编辑" src="${ctp}/static/images/bt_edit.gif" class="op_button" />
					<img onclick="window.location.href='${ctp}/product/delete/${product.id }?pageNo=${page.pageNo }'" 
